...
const APLICACAO_NOME = 'UTFilePR';

// Se a URL_RAIZ mudar, verifique arquivo .htaccess
const URL_RAIZ = '/web3/utfilepr/';
...
const URL_ICON = URL_PUBLICO . 'icon/';
const URL_FAVICON = URL_ICON . 'favicon/';
const URL_ARQUIVOS = URL_PUBLICO . 'arquivos/';
